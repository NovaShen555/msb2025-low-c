...
#define FSYNC_0()   (PORT_FSYNC->BSRR = (uint32_t)PIN_FSYNC << 16U)   /* 复位 */
#define FSYNC_1()   (PORT_FSYNC->BSRR = PIN_FSYNC)                    /* 置位 */

#define SCK_0()     (PORT_SCK->BSRR   = (uint32_t)PIN_SCK   << 16U)
#define SCK_1()     (PORT_SCK->BSRR   = PIN_SCK)

#define DAT_0()     (PORT_DAT->BSRR   = (uint32_t)PIN_DAT   << 16U)
#define DAT_1()     (PORT_DAT->BSRR   = PIN_DAT)

#define CS_0()      (PORT_CS->BSRR    = (uint32_t)PIN_CS    << 16U)
